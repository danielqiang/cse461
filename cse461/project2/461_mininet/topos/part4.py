...
class part4_topo(Topo):
    def build(self):
        ...
        # add hosts
        h10 = self.addHost('h10', mac='00:00:00:00:00:01', ip='10.0.1.10/24',
                           defaultRoute='via 10.0.1.1')
        h20 = self.addHost('h20', mac='00:00:00:00:00:02', ip='10.0.2.20/24',
                           defaultRoute='via 10.0.2.1')
        h30 = self.addHost('h30', mac='00:00:00:00:00:03', ip='10.0.3.30/24',
                           defaultRoute='via 10.0.3.1')
        serv1 = self.addHost('serv1', mac='00:00:00:00:00:04', ip='10.0.4.10/24',
                             defaultRoute='via 10.0.4.1')
        hnotrust1 = self.addHost('hnotrust1', mac='00:00:00:00:00:05', ip='172.16.10.100/24',
